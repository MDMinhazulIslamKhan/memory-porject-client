        ...
        <div className="card w-full bg-base-100 shadow-xl">
            ...
            <div className='flex justify-between'>
                <button className='ml-5 text-primary mb-2 flex items-center btn btn-ghost' onClick={() => { }}>
                    ...
                    <p className='ml-1 font-bold' onClick={() => dispatch(likePost(post._id))}>Like {likeCount}</p>
                </button>
                <button className='mr-5 text-primary mb-2 flex items-center btn btn-ghost' onClick={() => { }}>
                    ...
                    <p className='ml-1 font-bold' onClick={() => dispatch(deletePost(post._id))}>Delete</p>
                </button>
            </div>
        </div >
    );
